...
bosh interpolate \
  ...
  --ops-file="${PAAS_CF_DIR}/manifests/cf-manifest/manifest/operations/110-metrics.yml" \
  --ops-file="${PAAS_CF_DIR}/manifests/cf-manifest/manifest/operations/150-log-cache.yml" \
