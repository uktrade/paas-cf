...
grep -v -E "uaa_clients|client_secret|uaa_admin_password" cf-secrets-${TO}.yml > cf-secrets-${TO}-updated.yml
grep -E "uaa_clients|client_secret|uaa_admin_password" cf-secrets-${FROM}.yml >> cf-secrets-${TO}-updated.yml
